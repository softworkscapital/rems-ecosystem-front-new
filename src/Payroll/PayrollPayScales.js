            ...
            <div className="card-body">
              <div className="table-responsive" style={{ overflowY: 'auto', maxHeight: '400px', maxWidth: '1000px' }}>
                <table className="table table-striped table-bordered first">
                  <thead >
                    <tr >
                      <th style={{ fontWeight: "bold",fontSize:'12px' }}>Pay Scale-ID</th>
                      <th style={{ fontWeight: "bold",fontSize:'12px' }}>Grade-ID</th>
                      <th style={{ fontWeight: "bold",fontSize:'12px' }}>Company-ID</th>
                  ...
                  <tbody>
                    {payScales.map((item) => (
                      <tr key={item.hr_pay_scale_id}>
                        <td>{"Pay Scale-ID "}{item.hr_pay_scale_id}
                          {"\n Grade-ID"}{item.grade_id} 
                          {"\n Company-ID"} {item.company_id}</td>
...
export default PayrollPayScales;