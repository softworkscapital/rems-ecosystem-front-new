...
const AddDeduction = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'employee_id') {
      fetchDeductionRecords(value);
    }
  };

  const fetchDeductionRecords = async (employee_id) => {
    if (!employee_id) {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Sending POST to:", `${API_URL}/hr_deduction_register`);
    ...
    try {
      ...
      if (response.ok) {
        ...
        Swal.fire({
          ...
          navigate('/Deductions'); // Navigate back to Allowances page
        });
      } else {
      ...
      <div style={{ width: '950px', marginLeft: '280px', marginTop: '25px' }}>
        ...
        <div className="col-xl-12">
          ...
          >
            ...
            <Row className="mb-2">
              <Col sm={4}>
                <Form.Label>Max Deduction</Form.Label>
              </Col>
              <Col sm={8}>
                <Form.Control 
                  type="number" 
            ...
            <Row className="mb-2">
              <Col sm={4}>
                <Form.Label>Current Deduction</Form.Label>
              </Col>
              <Col sm={8}>
                <Form.Control 
                  type="number" 
            ...
            <Row className="mb-2">
              <Col sm={4}>
                <Form.Label>Remaining Deduction</Form.Label>
              </Col>
              <Col sm={8}>
                <Form.Control 
                  type="number" 
