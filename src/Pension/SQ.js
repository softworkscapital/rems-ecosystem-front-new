            ...
            <body>
                ...
                <div class="dashboard-header">
                    <nav class="navbar navbar-expand-lg bg-white fixed-top " align='left'>
                        <a  href="../menu"><p class="navbar-brand">REMS PENSION FUND </p> <p style={{marginTop: '-40px',marginLeft: '20px'}}>Logged in as: {username}{companyname}</p></a>
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                            ...
                            <ul class="navbar-nav ml-auto navbar-right-top">
                                ...
                                <li class="nav-item dropdown connection">
                                    <a class="nav-link" href="/menu" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="../assets/images/menu.png" alt=""   class="user-avatar-md rounded-circle" /> </a>
...
export default TopNav;
  ...
  const handleGoClick = () => {
        if (selectedSurveyId) {
            ...
            // Navigate to the next page with the survey ID, company ID, and branch ID as URL parameters
            navigate(`/nextPage?survey_id=${selectedSurveyId}&company_id=${companyId}&branch_id=${branchId}`);
        } else {
